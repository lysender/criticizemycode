...
<div id="form-wrapper">
	...
	<form class="form-stacked" action="<?php echo URL::site($code->get_edit_url()) ?>" method="post" enctype="multipart/form-data">
		<fieldset>
			<div class="clearfix">
			...
			<div class="clearfix">
				<div class="input">
					<input class="btn primary" type="submit" name="submit" id="submit" value="Update code" />
