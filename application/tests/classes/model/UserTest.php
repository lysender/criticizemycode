...
class Model_UserTest extends Kohana_UnitTest_TestCase
{
	...
	public function test_empty_all()
	{
		...
		{
			$this->assertType('Validation_Exception', $e);
	 ...
	 */
	public function test_activate_no_token()
	{
	 ...
	 * @expectedException Dc_Auth_Exception
	 */
	public function test_activate_invalid_token()
	{
		$user = Sprig::factory('user');
		
		$user->activate(Text::random('alnum', 32));
	}
